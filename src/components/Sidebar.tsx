...
export const Sidebar = ({ selectedRecipe, onClose, onEdit, onDelete, onFavoriteChange }: SidebarProps) => {
  ...
  return (
    <>
    {/* Mobile drawer (shows sidebar content instead of hiding) */}
    <div className="fixed inset-0 z-40 xl:hidden">
      ...
      />
      <aside className="absolute right-0 top-16 h-[calc(100vh-4rem)] w-full sm:w-[28rem] bg-white p-6 flex flex-col gap-6 border-l border-gray-100 overflow-y-auto">
